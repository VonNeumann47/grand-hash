...
from config import State, Lang, Action, \
                   log_path, known_users_path, telegram_uids_path, user_db_path, swears_path, \
...
def cloud_download_files():
    ...
    if need_to_download:
        ...
        logger.log(ADMIN_NAME, Action.CLOUD_DOWNLOAD, True, f"{len(need_to_download)} FILES DOWNLOADED")
...
def cloud_upload_files():
    ...
    logger.log(ADMIN_NAME, Action.CLOUD_UPLOAD, True)
